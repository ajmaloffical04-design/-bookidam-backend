...
module.exports = (pool) => {
    ...
    router.get('/', async (req, res) => {
        try {
            ...
            // Map columns back to frontend expectations
    ...
    router.post('/', async (req, res) => {
        const { clientName, phone, email, eventType, eventName, eventDate, preferredTime, preferredLocation, budget, description, imageUrl } = req.body;
